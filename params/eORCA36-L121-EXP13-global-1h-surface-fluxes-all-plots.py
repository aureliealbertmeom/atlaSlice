...
simulations=['EXP13-10']

# Variables considered for plots
# It must be in the list of acceptable variables
variables=['NETDHEATFLX','NETUPWFLX','PRECIP','WINDSP','SWDHEATFLX','LWDHEATFLX']
...
date_init='2017-01-01 11:00'
date_end='2017-01-03 23:00'

make_movies=True

plots_to_be_sent=['6843551400']
