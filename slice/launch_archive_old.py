...
def check_output_1sim_1reg(machine,configuration,simulation,region,variables,frequency,date_init,date_end,operation):
    ...
    #Depending on the operation the outputs are produced in different directories
    ...
    files_list = glob.glob(tdir+'/'+str(configuration)+str(sliced.ex[configuration][region])+'-'+str(simulation)+'_*.'+str(frequency)+'_*.nc')
...
def make_archive_1sim_1reg_1var(machine,configuration,simulation,region,var,frequency,date_init,date_end,operation,mpmdname):
    if operation == 'extract':
...
def make_archive(machine,configuration,simulations,regions,variables,frequency,date_init,date_end,operation):
    ...
    for simulation in simulations:
        for region in regions:
            for var in variables:
                make_archive_1sim_1reg_1var(machine,configuration,simulation,region,var,frequency,date_init,date_end,operation,mpmdname)
